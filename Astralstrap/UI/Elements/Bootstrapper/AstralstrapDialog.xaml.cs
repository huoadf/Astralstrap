...
{
    /// <summary>
    /// Interaction logic for AstralstrapDialog.xaml
    /// </summary>
    public partial class AstralstrapDialog : IBootstrapperDialog
    {
        private readonly AstralstrapDialogViewModel _viewModel;
        ...
        public AstralstrapDialog()
        {
            InitializeComponent();

            _viewModel = new AstralstrapDialogViewModel(this);
